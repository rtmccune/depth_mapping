...
abbr_flood_events = pd.read_csv('/rsstu/users/k/kanarde/NASA-Sunnyverse/rmccune/depth_mapping/data/CB_03_flood_events/abbr_flood_events.csv')
flood_events = pd.read_csv('/rsstu/users/k/kanarde/NASA-Sunnyverse/rmccune/depth_mapping/data/CB_03_flood_events/flood_events.csv')
