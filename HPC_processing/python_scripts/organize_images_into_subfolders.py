...
image_processing.image_utils.organize_images_by_flood_events(
    orig_images_folder, abbr_flood_events_csv, flood_events_folder, "orig_images"
)
image_processing.image_utils.organize_images_by_flood_events(
    labels_folder, abbr_flood_events_csv, flood_events_folder, "labels"
)
